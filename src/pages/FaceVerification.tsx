          ...
          <CardContent className="space-y-4">
            ...
            {docFiles[0] && (
              <div className="flex items-center justify-between p-3 bg-panel-secondary rounded-lg">
                ...
                <Button variant="ghost" size="sm" onClick={() => { removeDocFile(0); setDocumentImage(null); }}>
          ...
          <CardContent className="space-y-4">
            ...
            {presFiles[0] && (
              <div className="flex items-center justify-between p-3 bg-panel-secondary rounded-lg">
                ...
                <Button variant="ghost" size="sm" onClick={() => { removePresFile(0); setPresentedImage(null); }}>
                  <RotateCcw className="w-4 h-4" />
                </Button>
              </div>
            )}
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col items-center justify-center">
                  <div className="text-5xl font-bold mb-2" style={{ color: result.decision === 'match' ? '#22C55E' : '#EF4444' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-border">
                ...
                <div className="bg-panel-secondary rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold text-text">{result.similarity.toFixed(1)}%</p>
