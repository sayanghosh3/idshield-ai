...
def get_face_array(image_path):
    ...
    return np.array(face_crop)  # stays in memory, never saved to disk

img1_path = "dataset/images/val/03_aut_id_old_images_CS_CS03_14.jpg"
img2_path = "dataset/images/val/03_aut_id_old_images_HA_HA03_06.jpg"
...
if face1 is not None and face2 is not None:
    result = DeepFace.verify(
        ...
        img2_path=face2,
        model_name="ArcFace",
        detector_backend="skip",   # skip DeepFace's own detection since YOLO already found the face
